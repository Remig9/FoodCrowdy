        ...
        <Container direction={'row'}>
          ...
          <Text
            style={{
              ...
              fontSize: props.size || Fonts.small,
      ...
      <View style={{flexDirection: 'row'}}>
        ...
        <TextInput
          style={{
            ...
            borderLeftWidth: props.borderLeftWidth || 3,
            borderColor: props.borderColor || 'rgba(211, 213, 218, 1)',
            padding: props.padding || RR(5),
            paddingLeft: props.paddingLeft || 15,

            borderBottomWidth: props.borderBottomWidth || 3,
